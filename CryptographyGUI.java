...
public class CryptographyGUI extends Frame{
    ...
    Hill obj = new Hill();
    VigenereCipher obj1 = new VigenereCipher();
    Caesar obj2 = new Caesar();
    ...
    {
        Frame f2 = new Frame("Vigenere Cipher");
        ...
        submit.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                String text = encrypttxt.getText();
                String key = keytxt1.getText();
                
                enmessage = obj1.en(text, key);
                encryp.setText("Encryptic Text is : " + enmessage);
        ...
        transfer.addActionListener(new ActionListener() {
            @Override
            public void actionPerformed(ActionEvent e) {
                decrypttxt.setText(enmessage);
                keytxt2.setText(keytxt1.getText());
            }
        });
        ...
        decButton.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                String dmessage = "";
                // dmessage = obj.decrypt(emessage[0], emessage[1]);
                dmessage = obj1.de(enmessage, key);
                decryp.setText("Decryptic Text is : " + dmessage);
            }
        });
        //button work end
    ...
    public void caeserframe()
    {
        ...
        transfer.addActionListener(new ActionListener() {
            @Override
            public void actionPerformed(ActionEvent e) {
                decrypttxt.setText(cmessage);
                keytxt2.setText(Integer.toString(key));
            }
        });
        ...
        decButton.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                dmessage = obj2.decrypt(text, Integer.valueOf(key));

                String [] possible = new String[26];
                possible = obj2.bruteForce(dmessage);
        ...
        key2.setBounds(500,150,200,30);
        keytxt2.setBounds(500,200,200,30);
        decryp.setBounds(500,250,300,30);
        decButton.setBounds(500,300,100,30);
